(function($) {
  ...
  // Tooltips
  $(document)
    .on("mouseover", ".speaker-img-tooltip", function() {
      var self = $(this),
        tips = self.attr("data-tips");
      $tooltip =
        '<div class="eventalk-tooltip">' +
        '<div class="eventalk-tooltip-content">' +
        tips +
        "</div>" +
      ...
      var tBottomHeight = $tooltip
        .find(".eventalk-tooltip-bottom")
        .outerHeight();
  ...
  $(window).on("load", function() {
    ...
    if (iso_container.length > 0) {
      iso_container.each(function() {
        var $container = $(this),
          selector = $container
            .find(".isotope-classes-tab a.current")
            .attr("data-filter");
    ...
    if (eventCounter.length) {
      eventCounter.countdown("2020/03/16", function(e) {
        $(this).html(
          e.strftime(
  ...
  $(".menu-trigger").on("click", function() {
    ...
    if ($tempMenu.length) {
      self
        .find("i")
        .removeClass("flaticon-unchecked")
        .addClass("flaticon-menu");
      ...
      self
        .find("i")
        .removeClass("flaticon-menu")
        .addClass("flaticon-unchecked");
